...
# Map inputs to numerical values for prediction
...
input_data = np.array([
    age,
    sex_map[sex],
    cp.split(" ")[-1],  # Extract numerical type
    trestbps,
    chol,
    fbs_map[fbs],
    restecg.split(" ")[0],  # Extract numerical type
    thalach,
    exang_map[exang],
    oldpeak,
    slope.split(" ")[0],  # Extract numerical type
    ca,
    thal_map[thal]
]).reshape(1, -1)
